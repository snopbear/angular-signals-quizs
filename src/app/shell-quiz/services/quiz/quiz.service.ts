...
import { IBackendQuestion } from '../../types/backend-question.interface';
...
export class QuizService {
  ...
  // questions = signal<IQuestion[]>(this.getMockQuestions());
  ...
  getQuestions(): Observable<IQuestion[]> {
    ...
    return this.http.get<{ results: IBackendQuestion[] }>(apiUrl).pipe(
      map((response) => {
